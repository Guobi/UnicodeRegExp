...
function App() {
  const regExpArray = [
    ...
    ['(?=[\\p{Emoji}])[\\D]', 'Emoji'],
    ['\\p{ASCII}', 'ASCII'],
    ['\\p{sc=Latin}', 'Latin script: English, German, French...'],
    ['\\p{sc=Han}', 'Han script: Chinese, Japanese and Korean'],
    ['\\p{sc=Hiragana}', 'Japanese Hiragana 平假名'],
    ['\\p{sc=Katakana}', 'Japanese Katakana 片假名'],
    ['\\p{sc=Hang}', 'Hangeul (한글)'],
    ['\\p{sc=Arabic}', 'Arabic'],
    ['\\p{sc=Cyrillic}', 'Cyrillic script: Russian, Ukrainian, Bulgarian, Macedonian...'],
    ['\\p{sc=Greek}', 'Greek'],
    ['\\p{sc=Hebrew}', 'Hebrew'],
